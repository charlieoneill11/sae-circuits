...
roc_results = {}
num_codes_list = [5, 10, 25, 50, 100, 250]
...
for num_codes in num_codes_list:
    ...
    for i in range(num_trials):
        ...
        if task_type == 'node':
            ...
            print(f"\n\nNormalise: {normalise}")
            y_true, y_pred, fpr, tpr, node_roc_auc, f1, thresholds = gen_softmaxed_unique_to_pos(all_indices, ground_truth_array, head_labels, normalise=normalise, num_codes=num_codes)
            ...
            code_results.append(node_roc_auc)
    ...
    roc_results[num_codes] = code_results

print(roc_results)
# Save roc_results as JSON
with open(f'../output/data/roc_results_num_codes_{task_type}.json', 'w') as f:
